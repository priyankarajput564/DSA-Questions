...
public class String34  {
    public static void main (String[] args) {
        ...
        while(t-->0){
            ...
            System.out.println("The characters can be arranged so that no consecutive characters are same : "+ob.rearrangeString(s));
        }
    }
}
...
class Solution58 {
    ...
    static int rearrangeString(String str)
    {
        int n = str.length();
