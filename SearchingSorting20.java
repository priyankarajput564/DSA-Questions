...
public class SearchingSorting20  {

    public static long getHashValue(long hash[][],int startIndOfI,int startIndOfJ,int endIndOfI,int endIndOfJ,long p1[],long p2[])
    {
        long res = hash[endIndOfI][endIndOfJ] - hash[endIndOfI][startIndOfJ - 1] - hash[startIndOfI - 1][endIndOfJ] + hash[startIndOfI - 1][startIndOfJ - 1];
    ...
    public static boolean ninjaAndSwordHelper(long mat1[][],long mat2[][],int size,long p1[],long p2[], long hashMatA[][], long hashMatB[][])
    {
    ...
    public static void main(String args[])
    {
        ...
        System.out.println(ninjaAndSword(a,b,m,n,x,y));
    }
}